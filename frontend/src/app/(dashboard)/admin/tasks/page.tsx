...
import { Plus, ListTodo, LayoutGrid, Columns3 } from "lucide-react";
import { Task, TaskComment } from "@/types";

type ViewMode = "grid" | "kanban";

export default function TasksPage() {
  const { tasks, loading, fetchTasks, createTask, updateTaskStatus, getComments, addComment, editComment, deleteComment } = useTasks();
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  {selectedTask.assignee && (
                    <div>
                      <span className="text-orion-silver/60">Responsavel:</span>
                      <span className="ml-2">{selectedTask.assignee.name}</span>
                    </div>
                  )}
